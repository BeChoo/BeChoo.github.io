...
const Profile = () => {
    ...
    return (
        <div className="profile">
                ...
                <div className="reviews">
                    {userReviews.map((review, index) => (
                        <div key={index} className="review-box">
                            <img src={review.hotelImageURL} alt="Hotel" style={{ width: '100px', float: 'left' }} />
            ...
            <button onClick={toggleSavedHotels}>{showSavedHotels ? 'Hide Saved Hotels' : 'Show Saved Hotels'}</button>
            {showSavedHotels && (
